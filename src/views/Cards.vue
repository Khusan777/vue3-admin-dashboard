<template>
  <div class="container px-6 mx-auto grid">
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
      ...
      <Card>
        <div class="flex items-center">
          <div
            class="p-4 mr-4 text-orange-500 bg-orange-100 rounded-lg dark:text-orange-100 dark:bg-orange-500"
          >
      ...
      <Card>
        <div class="flex items-center">
          <div
            class="p-4 mr-4 text-green-500 bg-green-100 rounded-lg dark:text-green-100 dark:bg-green-500"
          >
            <CashIcon class="w-6" />
          </div>
          <div>
      ...
      <Card>
        <div class="flex items-center">
          <div
            class="p-4 mr-4 text-blue-500 bg-blue-100 rounded-lg dark:text-blue-100 dark:bg-blue-500"
          >
      ...
      <Card>
        <div class="flex items-center">
          <div
            class="p-4 mr-4 text-teal-500 bg-teal-100 rounded-lg dark:text-teal-100 dark:bg-teal-500"
          >
            <ChatIcon class="w-6" />
          </div>
          <div>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2">
      <Card>
        <h4 class="my-4 font-semibold text-gray-600 dark:text-gray-300">Revenue</h4>
      ...
      <Card class="bg-red-100">
        <h4 class="my-2 font-semibold text-gray-600 dark:text-gray-300">Colored card</h4>
        <p class="text-gray-600 dark:text-gray-400">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fuga, cum commodi a omnis
          numquam quod? Totam exercitationem quos hic ipsam at qui cum numquam, sed amet ratione!
          Ratione, nihil dolorum.
